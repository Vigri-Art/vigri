...
export function NavWrapper({ children, user, profile }: NavWrapperProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="flex max-w-full mx-auto px-4 h-screen align-middle"> 
        
        {/* 2. Grid Layout for Desktop (Sidebar + Content) */}
        <div className="mx-auto grid grid-cols-1 m:grid-cols-12 lg:grid-cols-12 gap-6 pt-8 lg:pt-8"> 
          ...
          <div className="mx-auto sm:col-span-1 lg:col-span-9">
            {children}
          </div>
        </div>
      </main>
